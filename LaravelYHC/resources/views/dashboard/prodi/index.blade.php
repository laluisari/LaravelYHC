...
<div class="container">
  <a href="{{ route('prodi.create') }}"><button class="btn btn-primary my-3">Tambah Data</button></a>
  <div class="row">
      ...
      <table class="table table-striped table-sm">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $prodi->name }} | {{ $prodi->id }}</td>
            <td class="text-center mx-2"> 
              <a href="{{ route('prodi.edit', $prodi->id) }}" class="badge bg-warning"><span data-feather="edit" class="align-text-bottom"></span></a>
